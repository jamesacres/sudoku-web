...
const Header = () => {
  return (
    <>
      <nav className="fixed top-0 left-0 z-50 flex w-screen flex-wrap items-center justify-between border-b border-stone-200 bg-stone-50 px-4 pt-[env(safe-area-inset-top)] pb-2 dark:border-zinc-600 dark:bg-zinc-900">
