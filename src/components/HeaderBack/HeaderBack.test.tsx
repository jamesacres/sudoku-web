...
describe('HeaderBack', () => {
  ...
  describe('on home page', () => {
    it('should render Sudoku Race button on home page', () => {
      const { usePathname } = require('next/navigation');
      usePathname.mockReturnValue('/');
    ...
    it('should have gradient text styling on Sudoku Race button', () => {
      const { usePathname } = require('next/navigation');
      usePathname.mockReturnValue('/');
    ...
    it('should call router.replace with START_PUZZLE tab when button clicked', async () => {
      const { usePathname } = require('next/navigation');
      usePathname.mockReturnValue('/');
    ...
    it('should have cursor-pointer class on Sudoku Race button', () => {
      const { usePathname } = require('next/navigation');
      usePathname.mockReturnValue('/');
    ...
    it('should have active opacity effect on Sudoku Race button', () => {
      const { usePathname } = require('next/navigation');
      usePathname.mockReturnValue('/');
    ...
    it('should have font styling on Sudoku Race button', () => {
      const { usePathname } = require('next/navigation');
      usePathname.mockReturnValue('/');
    ...
    it('should have transition effect on Sudoku Race button', () => {
      const { usePathname } = require('next/navigation');
      usePathname.mockReturnValue('/');
  ...
  describe('on other pages', () => {
    ...
    it('should not render Sudoku Race button on other pages', () => {
      const { usePathname } = require('next/navigation');
      usePathname.mockReturnValue('/puzzle');
