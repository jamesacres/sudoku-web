  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative flex max-h-[90vh] w-full max-w-md flex-col rounded-2xl border border-white/20 bg-white/95 shadow-2xl backdrop-blur-xl dark:border-gray-700/50 dark:bg-gray-900/95">
        ...
        <div className="flex-shrink-0 rounded-b-2xl border-t-2 border-gray-300/70 bg-white/95 backdrop-blur-xl dark:border-gray-600/70 dark:bg-gray-900/95 shadow-[0_-16px_32px_-4px_rgba(0,0,0,0.4)]">
